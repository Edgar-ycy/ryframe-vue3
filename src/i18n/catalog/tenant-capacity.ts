...
export const tenantCapacityMessages = {
  'zh-CN': {
    tenantCapacity: {
      ...
      productPlanVersion: '产品套餐版本',
      selectPublishedPlanVersion: '请选择已发布套餐版本',
      dataTarget: '数据目标',
      selectDataTarget: '请选择合格的数据目标',
      creationOptionsUnavailable: '套餐版本或数据目标加载失败，暂时无法创建租户。',
      ...
      planVersionRequired: '请选择已发布套餐版本',
      dataTargetRequired: '请选择数据目标',
  ...
  'en-US': {
    tenantCapacity: {
      ...
      productPlanVersion: 'Product plan version',
      ...
      planVersionRequired: 'Select a published plan version',
      dataTargetRequired: 'Select a data target',
