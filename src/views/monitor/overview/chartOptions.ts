...
export function scheduleChartOption(
  ...
  return {
    ...
    series: [
      {
        name: t('monitor.overview.enqueued'),
        type: 'bar',
        stack: 'schedule',
        data: buckets.map((value) => value.schedule_enqueued),
      },
      {
        name: t('monitor.overview.skippedMisfire'),
        type: 'bar',
        stack: 'schedule',
        data: buckets.map((value) => value.schedule_skipped_misfire),
      },
      {
        name: t('monitor.overview.skippedConcurrency'),
        type: 'bar',
        stack: 'schedule',
        data: buckets.map((value) => value.schedule_skipped_concurrency),
      },
      {
        name: t('monitor.overview.targetUnavailable'),
        type: 'bar',
        stack: 'schedule',
        data: buckets.map((value) => value.schedule_target_unavailable),
      },
      {
        name: t('monitor.overview.invalidConfiguration'),
        type: 'bar',
        stack: 'schedule',
        data: buckets.map((value) => value.schedule_invalid_configuration),
      },
    ],
  }
}
...
export function accessChartOption(
  ...
  return {
    ...
    series: [
      {
        name: t('monitor.overview.loginSuccess'),
        type: 'bar',
        stack: 'login',
        data: buckets.map((value) => value.login_success),
      },
      {
        name: t('monitor.overview.loginFailure'),
        type: 'bar',
        stack: 'login',
        data: buckets.map((value) => value.login_failure),
      },
      {
        name: t('monitor.overview.operationSuccess'),
        type: 'bar',
        stack: 'operation',
        data: buckets.map((value) => value.operation_success),
      },
      {
        name: t('monitor.overview.operationFailure'),
        type: 'bar',
        stack: 'operation',
        data: buckets.map((value) => value.operation_failure),
      },
    ],
  }
}
