...
import { getMenuPage, getRouteKeyByPermissionCode, menuPageRegistry } from '@/features/pageRegistry'
...
describe('菜单页面注册表', () => {
  ...
  it('自动汇总领域、生成资源和可裁剪功能页面', () => {
    ...
    expect(getMenuPage('system.service-accounts')?.requiredCapabilities).toEqual([
